package JUnit5.JUnit_ParameterizedTests.DefiningAnArgumentConverter.test;
...
public class EmployeeTest {
    ...
    void nameTest(String lName) {
        ...
        Employee employee = new JUnit5.JUnit_ParameterizedTests.RunningParameterizedTestsWithValueSource.main.Employee("Brian", lName, 1011, 'M', "Tester", 50000.0, "Contract");
